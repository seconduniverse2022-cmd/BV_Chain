...
import (
	...
	"github.com/bitvault/secrets/helper"
...
func parseBurnContractInfo(burnContractInfoRaw string) (*bvbft.BurnContractInfo, error) {
...
// GenerateExtraDatabvbft populates Extra with specific fields required for bvbft consensus protocol
func GenerateExtraDatabvbft(validators []*validator.ValidatorMetadata) ([]byte, error) {
	delta := &validator.ValidatorSetDelta{
		Added:   validators,
		Removed: bitmap.Bitmap{},
	}

	extra := bvbft.Extra{Validators: delta, Checkpoint: &bvbft.CheckpointData{}}
