...
func setFlags(cmd *cobra.Command) {
	...
	cmd.MarkFlagsMutuallyExclusive(rootHelper.TestModeFlag, bvbftsecrets.PrivateKeyFlag)
	cmd.MarkFlagsMutuallyExclusive(rootHelper.TestModeFlag, bvbftsecrets.AccountConfigFlag)
	cmd.MarkFlagsMutuallyExclusive(rootHelper.TestModeFlag, bvbftsecrets.AccountDirFlag)
...
func runCommand(cmd *cobra.Command, _ []string) error {
	...
	if consensusConfig.Bridge == nil {
		consensusConfig.Bridge = &bvbft.BridgeConfig{}
	}
