...
This command funds the initialized accounts via `bitvault bvbft-secrets` command.

```bash
$ bitvault rootchain fund --data-dir data-dir- --num 2
```

or

```bash
$ bitvault rootchain fund --data-dir data-dir-1
```
