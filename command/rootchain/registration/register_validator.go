...
func setFlags(cmd *cobra.Command) {
	...
	cmd.MarkFlagsMutuallyExclusive(bvbftsecrets.AccountConfigFlag, bvbftsecrets.AccountDirFlag)
}
...
func runCommand(cmd *cobra.Command, _ []string) error {
	...
	secretsManager, err := bvbftsecrets.GetSecretsManager(params.accountDir, params.accountConfig, true)
	if err != nil {
		return err
	}
