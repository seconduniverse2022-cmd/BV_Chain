...
import (
	...
	cmdHelper "github.com/bitvault/command/helper"
	...
	"github.com/bitvault/consensus/bvbft/contractsapi/artifact"
...
var (
	...
	metadataPopulatorMap = map[string]func(*bvbft.RootchainConfig, types.Address){
		stateSenderName: func(rootchainConfig *bvbft.RootchainConfig, addr types.Address) {
			rootchainConfig.StateSenderAddress = addr
		},
		getProxyNameForImpl(checkpointManagerName): func(rootchainConfig *bvbft.RootchainConfig, addr types.Address) {
			rootchainConfig.CheckpointManagerAddress = addr
		},
		getProxyNameForImpl(blsName): func(rootchainConfig *bvbft.RootchainConfig, addr types.Address) {
			rootchainConfig.BLSAddress = addr
		},
		getProxyNameForImpl(bn256G2Name): func(rootchainConfig *bvbft.RootchainConfig, addr types.Address) {
			rootchainConfig.BN256G2Address = addr
		},
		getProxyNameForImpl(exitHelperName): func(rootchainConfig *bvbft.RootchainConfig, addr types.Address) {
			rootchainConfig.ExitHelperAddress = addr
		},
		getProxyNameForImpl(rootERC20PredicateName): func(rootchainConfig *bvbft.RootchainConfig, addr types.Address) {
			rootchainConfig.RootERC20PredicateAddress = addr
		},
		getProxyNameForImpl(childERC20MintablePredicateName): func(
			rootchainConfig *bvbft.RootchainConfig, addr types.Address) {
			rootchainConfig.ChildMintableERC20PredicateAddress = addr
		},
		rootERC20Name: func(rootchainConfig *bvbft.RootchainConfig, addr types.Address) {
			rootchainConfig.RootNativeERC20Address = addr
		},
		erc20TemplateName: func(rootchainConfig *bvbft.RootchainConfig, addr types.Address) {
			rootchainConfig.ChildERC20Address = addr
		},
		getProxyNameForImpl(rootERC721PredicateName): func(rootchainConfig *bvbft.RootchainConfig, addr types.Address) {
		...
		erc721TemplateName: func(rootchainConfig *bvbft.RootchainConfig, addr types.Address) {
			rootchainConfig.ChildERC721Address = addr
		},
		getProxyNameForImpl(rootERC1155PredicateName): func(rootchainConfig *bvbft.RootchainConfig, addr types.Address) {
		...
		erc1155TemplateName: func(rootchainConfig *bvbft.RootchainConfig, addr types.Address) {
			rootchainConfig.ChildERC1155Address = addr
		},
		getProxyNameForImpl(customSupernetManagerName): func(rootchainConfig *bvbft.RootchainConfig, addr types.Address) {
...
type deploymentResultInfo struct {
	RootchainCfg   *bvbft.RootchainConfig
	SupernetID     int64
...
func runCommand(cmd *cobra.Command, _ []string) {
	...
	chainConfig.Params.Engine[bvbft.ConsensusName] = consensusCfg
...
func deployContracts(outputter command.OutputFormatter, client *jsonrpc.Client, chainID int64,
	...
	rootchainConfig := &bvbft.RootchainConfig{
...
func populateExistingTokenAddr(eth *jsonrpc.Eth, tokenAddr, tokenName string,
	rootchainCfg *bvbft.RootchainConfig) error {
...
func registerChainOnStakeManager(txRelayer txrelayer.TxRelayer,
	rootchainCfg *bvbft.RootchainConfig, deployerKey ethgo.Key) (int64, error) {
