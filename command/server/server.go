...
import (
	...
	"github.com/bitvault/command/server/config"
	"github.com/bitvault/command/server/export"
...
func GetCommand() *cobra.Command {
	serverCmd := &cobra.Command{
		Use:     "server",
		Short:   "The default command that starts the bitvault client, by bootstrapping all modules together",
		PreRunE: runPreRun,
		Run:     runCommand,
	}
...
func setFlags(cmd *cobra.Command) {
	...
	cmd.Flags().StringVar(
		...
		"the data directory used for storing bitvault client data",
	)
	...
	cmd.Flags().BoolVar(
		...
		"start the state sync relayer service (bvbft only)",
	)
