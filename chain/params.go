...
// ForksInTime should contain all supported forks by current bitvault version
...
// AllForksEnabled should contain all supported forks by current bitvault version
