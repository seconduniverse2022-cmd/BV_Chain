...
This is the minimum hardware configuration required to set up a bitvault-powered chain:
...
| Network security | Ensure that network ports used by bitvault are not blocked by firewalls or other security measures. |
