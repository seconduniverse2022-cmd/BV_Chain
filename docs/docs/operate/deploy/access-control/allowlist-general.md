...
ACLs or Access Control Lists are a way of managing permissions in your bitvault-powered chain. In this context, an ACL is essentially a list of addresses and their corresponding roles.
...
Below is an overview of the ABI for the ACL in bitvault:
...
**For more information about how ACLs work in bitvault, check out the overview guide [<ins>here</ins>](../../../design/runtime/allowlist.md).**
...
bitvault ACLs are implemented as precompiles, which are built-in contracts within the bitvault client. You can interact with these ACL precompiles using libraries like ether.js and web3.js.
...
2. Create a contract instance for the ACL precompile using the ABI and the provider connected to the bitvault-powered chain.
