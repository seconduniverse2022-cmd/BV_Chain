...
<div align="center">
  <img src="/img/bitvault/bridge-deposit-rootchain.excalidraw.png" alt="bridge" width="100%" height="30%" />
</div>

### Depositing from the Childchain

<div align="center">
  <img src="/img/bitvault/bridge-deposit-childchain.excalidraw.png" alt="bridge" width="100%" height="30%" />
</div>
...
This command deposits ERC-20 tokens from a rootchain to a bitvault-powered chain. 
...
In this example, we're depositing ERC-20 tokens to a test bitvault instance:
...
This command deposits ERC-721 tokens from a rootchain to a bitvault-powered chain.
...
```bash
./bitvault bridge deposit-erc721 \
    --sender-key <hex_encoded_depositor_private_key> \
    --receivers <receivers_addresses> \
    --token-ids <token_ids> \
...
In this example, we're depositing ERC-721 tokens to a test bitvault instance:
...
This command deposits ERC-1155 tokens from the rootchain to the bitvault-powered chain.
...
```bash
./bitvault bridge deposit-erc1155 \
...
In this example, we're depositing ERC-1155 tokens to a test bitvault instance:
