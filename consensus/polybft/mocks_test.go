...
var _ bvbftBackend = (*bvbftBackendMock)(nil)

type bvbftBackendMock struct {
	mock.Mock
}

// GetValidators retrieves validator set for the given block
func (p *bvbftBackendMock) GetValidators(blockNumber uint64, parents []*types.Header) (validator.AccountSet, error) {
	...
	panic("bvbftBackendMock.GetValidators doesn't support such combination of arguments") //nolint:gocritic
}

func (p *bvbftBackendMock) GetValidatorsWithTx(blockNumber uint64, parents []*types.Header,
	...
	panic("bvbftBackendMock.GetValidatorsWithTx doesn't support such combination of arguments") //nolint:gocritic
}
