...
type checkpointManager struct {
	...
	// consensusBackend is abstraction for bvbft consensus specific functions
	consensusBackend bvbftBackend
...
func newCheckpointManager(key ethgo.Key, checkpointOffset uint64,
	...
	blockchain blockchainBackend, backend bvbftBackend, logger hclog.Logger,
