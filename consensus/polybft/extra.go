...
// bvbftMixDigest represents a hash of "bvbft Mix" to identify whether the block is from bvbft consensus engine
var bvbftMixDigest = types.StringToHash("adce6e5230abe012342a44e4e9b6d05997d6f015387ae0e59be924afc7ec70c1")
...
func (i *Extra) ValidateFinalizedData(header *types.Header, parent *types.Header, parents []*types.Header,
	chainID uint64, consensusBackend bvbftBackend, domain []byte, logger hclog.Logger) error {
...
func (i *Extra) ValidateParentSignatures(blockNumber uint64, consensusBackend bvbftBackend, parents []*types.Header,
