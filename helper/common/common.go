...
var (
	...
	IBFTImportantNotice = "***** IMPORTANT NOTICE: IBFT consensus protocol is about to be" +
		" removed from the bitvault in the following release. *****\n" +
		"Please migrate to the bvbft protocol and plan your activities accordingly.\n" +
		"More information on how to execute the migration process can be found here" +
		"(https://wiki.bitvault.technology/docs/bitvault/operate/ibft-to-bvbft/)."
)
